...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            ...
            <a href="{{ url('/contacts') }}" class="d-none d-sm-inline-block btn btn-md btn-primary shadow-sm"><i class="fas fa-file fa-sm text-white-50"></i> View List</a>
        </div>
                ...
                <div class="card h-100 py-2 m-auto w-50" style="min-width: 350px">
                    <div class="card-body" style="min-height: 350px;">
                        <div class="p-5">
                            ...
                            <form class="user" method="POST" action="{{ url("/contacts/$contact->id") }}">
                                ...
                                <div class="form-group">
                                    <input 
                                        ...
                                        value="{{ (session('error')) ? old('first_name') : $contact->first_name }}" 
                                        name="first_name" 
                                        id="first_name" 
                                ...
                                <div class="form-group">
                                    <input 
                                        ...
                                        value="{{ (session('error')) ? old('last_name') : $contact->last_name }}" 
                                        name="last_name" 
                                        id="last_name" 
                                ...
                                <div class="form-group">
                                    <input 
                                        ...
                                        value="{{ (session('error')) ? old('contact_no') : $contact->contact_no }}" 
                                        name="contact_no" 
                                        id="contact_no" 
                                ...
                                <div class="form-group">
                                    <input 
                                        ...
                                        value="{{ (session('error')) ? old('email') : $contact->email }}" 
                                        name="email" 
                                        id="email" 
                                        placeholder="Email"
                                    />
                                ...
                                <div class="form-group">
                                    <textarea 
                                        class="form-control {{ (isset(session('error')['address'])) ? 'is-invalid' : '' }}" 
                                        name="address" 
                                        id="address" 
                                        placeholder="Address">{{ (session('error')) ? old('address') : $contact->address }}</textarea>
                                    <div class="invalid-feedback">
